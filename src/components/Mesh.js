    ...
    render() {
        ...
        return (
            <>
                ...
                <StandardMaterial key={material.name?material.name:this.props.mesh.name} name={material.name?material.name:this.props.mesh.name} id={this.props.mesh.material.length >1 ?index:undefined} updateMesh={this.updateMeshLocal}>
